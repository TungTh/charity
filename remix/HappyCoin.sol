...
contract HappyCoin is ERC20, SafeMath {
    ...
    function fund(address to,uint256 tokens) public returns(bool ok){
        balances[to] = safeAdd(balances[to],tokens);
        totalSupply= safeAdd(totalSupply,tokens);
        return true;
    }
     function withdraw(address to,address _admin,uint256 tokens) public returns(bool ok){
